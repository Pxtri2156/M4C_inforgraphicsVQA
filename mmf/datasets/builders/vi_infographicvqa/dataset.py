...
class ViInfographicVQADataset(MMFDataset):
    def __init__(self, config, dataset_type, imdb_file_index, *args, **kwargs):
        super().__init__("vi_infographicvqa", config, dataset_type, index=imdb_file_index)
    ...
    def add_answer_info(self, sample_info, sample):
        ...
        assert not self.config.fast_read, (
            "In ViInfographicVQADataset, online OCR sampling is incompatible "
