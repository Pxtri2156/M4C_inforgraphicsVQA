...
def repair_lmdb_format(bboxes_folder, json_path, ocr_results_path, sub_num, output ):
    ...
    # print("info dataset", info_dataset)
        for i, annot in enumerate(annots_data):
            ...
            print("Phrase {}/ {} processing [{}/{}]: {}".format(k/distance + 1,sub_num, i, num_file, image_name))
...
def main(args):
    repair_lmdb_format(args.bboxes, args.origin_annot, args.ocr_results,args.sub_num, args.output)
...
def get_parser():
    ...
    parser.add_argument(
        "--sub_num",
        type=int,
        help="The number of sub image for train 3 or 6",
        default=3,
    )
...
'''
python utils/repair_annotation_split_train.py \
