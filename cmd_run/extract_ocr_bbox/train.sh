FOLDER_PATH_TO_DATASET="/mlcv/Databases/VN_InfographicVQA/train/documents/"
IMDB_FILE="env_variable/data/datasets/vi_infographicvqa/defaults/annotations/infoVQA_train_vi.npy"
