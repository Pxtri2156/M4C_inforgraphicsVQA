FOLDER_PATH_TO_DATASET="/mlcv/Databases/VN_InfographicVQA/test/documents/"
IMDB_FILE="env_variable/data/datasets/vi_infographicvqa/defaults/annotations/infoVQA_test_vi.npy"
