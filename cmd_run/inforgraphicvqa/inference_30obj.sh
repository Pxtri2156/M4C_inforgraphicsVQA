...
CUDA_VISIBLE_DEVICES=3 mmf_predict config=projects/m4c/configs/inforgraphicvqa/defaults.yaml \
    ...
    checkpoint.resume_file="env_variable/save/inforgraphicVQA/config_v2/best.ckpt"
